...
// This file is disabled in standalone mode - AP_Filter requires AP_Param framework
#error "AP_Filter requires AP_Param framework - use filter classes directly instead"
#endif
